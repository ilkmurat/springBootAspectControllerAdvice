package com.murat.customerinfo.config.aspect;
...
public class LoggingAspect {
    ...
    @Around("execution(* com.murat.customerinfo.service.*.*(..))")
    ...
    @Before("execution(* com.murat.customerinfo.service.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.murat.customerinfo.service.*.*(..))", throwing = "ex")
